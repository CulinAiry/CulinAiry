...
export default function NewRecipe() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    fullQuestion +=
      " I would like to receive your response in Markdown format and provide step-by-step instructions please. It is vital that you wrap the title of the recipe in an <h2> tag.";
  ...
  return (
    <>
      ...
      >
        <div
          className="container md:mx-auto pb-4 text-center"
          style={{ color: "#ffe4e1"}}
        >
          <p className="text-[1.3em]">
          To request a recipe with specific constraints, fill out the form and click "Ask".
          Alternatively, you can click "Surprise Me" to receive a random recipe with no specific requirements.
          </p>
          <p className="text-[0.95em] mb-8">
          (Leave a field blank if you don't want to include it in the request.)
          </p>
        </div>
        <form
        ...
        {ended && (
            <div className="col-span-2 flex justify-center mb-10">
              <button
                ...
                className="hyper bg-[#3a439c] hover:bg-[#2e3687] text-white font-bold py-2 px-4 sm:text-lg sm:py-3 sm:px-6 md:text-xl md:py-4 md:px-8 lg:text-2xl lg:py-5 lg:px-10"
              >
                Surprise Me
              </button>
            </div>
          ...
          {ended && (
            <div className="col-span-2 flex justify-end">
              <button
                ...
                className="hyper bg-[#3a439c] hover:bg-[#2e3687] text-white font-bold mr-[20px] py-2 px-7 sm:text-lg sm:py-3 sm:px-6 md:text-xl md:py-4 md:px-8 lg:text-2xl lg:py-5 lg:px-10"
              >
                Ask
              </button>
            </div>
